%KF_NMCDA_INIT  KF/NMCDA Data structure initialization
%
% Syntax:
%   S = kf_nmcda_init(np,M0,P0,dt,[W])
%
% Author:
%   Simo Särkkä, 2003
%
...
%
% See also:
%   KF_NMCDA_PREDICT, KF_NMCDA_UPDATE
...
function S = kf_nmcda_init(np,M0,P0,dt,W)
  if nargin < 5
      W = ones(1,np)/np;
  end
  str = struct(...
